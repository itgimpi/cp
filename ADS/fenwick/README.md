...
Из бинарног записа броја треба да се избаци прва десна јединица. Ако се користи потпуни комплемент, $k\mathbin{\&}-k$ је број који садржи само једну јединицу и то на месту последње јединице у запису броја $k$. Одузимањем те вредности од броја $k$ тј. изразом $k-(k\&-k)$ брише се последња јединица у бинарном запису броја $k$. 
